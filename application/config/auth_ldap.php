...
$config['hosts'] = array('10.150.140.11');
$config['ports'] = array(389);//array(389);
$config['basedn'] = 'etisalatng';//mycompany=etisalatng,dc=mycompany,dc=com';
$config['login_attribute'] = 'uid';
$config['proxy_user'] = '';
$config['proxy_pass'] = '';
$config['roles'] = '';//array(1 => 'User',     3 => 'Power User',    5 => 'Administrator');
