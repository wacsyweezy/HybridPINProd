			...
			<div class="hpanel"  style="padding-bottom:15px;">
						...
						<div class="col-md-5">
							...
							<?php
								if(!isset($_GET['start']) && !isset($_GET['end'])) {
									echo '<i class="fa fa-calendar"></i> '.date('D F jS, Y').' Bulk Orders';
								}
								else {
				...
				<div class="panel-body table table-responsive">
					<?php
						...
						?>
					<table id='pending-order' class='table table-striped table-bordered' style='width:100%;'>
						<thead>
							<tr>
								<th>Order No</th>
								<th>Trade Code</th>
