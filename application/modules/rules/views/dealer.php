...
<div class="small-header transition animated fadeIn">
	<div class="hpanel">
		<div class="panel-body">
			...
			<small>Rule Definition for Dealers</small>
		</div>
	</div>
</div>
		...
		<div style="" class="col-lg-12">
			...
			<div class="hpanel">
				<ul class="nav nav-tabs">
					<li class="active"><a aria-expanded="true" data-toggle="tab" href="components.html#tab-1"> Available Dealer Rules</a></li>
					<li class=""><a aria-expanded="false" data-toggle="tab" href="components.html#tab-2"> Add New Dealer Rule</a></li>
				</ul>
				<div class="tab-content">
							...
							<table id='datatable-buttons' class='table table-striped table-bordered' style='width:100%;'>
								...
								<?php
									...
									<tr>
										...
										<td style="width:70px;">
											<a class="pull-right btn btn-xs btn-danger" title="Remove Rule" href="'.base_url().'rules/removedealer/?rule='.$rule->RULEID.'"><i class="fa fa-times"></i></a>
					...
					<div id="tab-2" class="tab-pane">
						<div class="panel-body">
							<?php echo form_open('rules/adddealerrule', array('class' => 'form-horizontal form-label-left', 'id'=>'demo-form2')); ?>
											...
											<?php
												if(count($dealers)>=1) {
													foreach($dealers as $dealer) {
														echo '<option value="'.$dealer->PARTYCODE.'"><b>'.$dealer->PARTYCODE.'</b> - '.$dealer->PARTYNAME.'</option>';
													}
												}
												else {
